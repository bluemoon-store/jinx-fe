...
export const ShopProductCard: FunctionComponent = () => {
  return (
    <div className="rounded-num-8 border-darkslateblue box-border flex w-full min-w-0 flex-col items-center justify-center gap-2 border-[1px] border-solid bg-gray-200 p-3 sm:gap-3">
      <img
      ...
      <div className="flex w-full max-w-36 flex-col items-center gap-0.5">
        ...
        <div className="text-whitesmoke-300 font-commissioner sm:text-num-16 flex items-center justify-center gap-0.5 text-sm">
          ...
          <div className="rounded-num-6 py-num-0 flex items-center justify-center px-1.5 text-white [background:linear-gradient(180deg,_rgba(255,_255,_255,_0.05),_rgba(255,_255,_255,_0.14))]">
            <b className="leading-num-24 [text-shadow:0px_0px_8.63px_rgba(0,_0,_0,_0.6)]">$2.50</b>
          </div>
        </div>
      </div>
      <button
        type="button"
        className="font-commissioner rounded-num-6 sm:px-num-10 sm:text-num-14 flex min-h-[44px] w-full min-w-0 items-center justify-center gap-1.5 bg-gray-700 px-4 py-2 text-left text-white sm:gap-[5px] sm:py-1.5"
      >
        <CentralIcon
          name="IconZap"
          join="round"
