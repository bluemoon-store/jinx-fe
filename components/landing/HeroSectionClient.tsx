...
const HeroSectionClient: FunctionComponent<Props> = ({ categories }) => {
  ...
  return (
    <section className="bg-background dark:bg-[#051329] w-full">
      <div className="mx-auto w-full max-w-[1476.9px] overflow-x-auto px-4 sm:px-6 lg:px-8">
        <main className="bg-background dark:bg-[#051329] flex w-full flex-col pt-4 pb-0 md:pt-8">
          <div className="bg-card dark:bg-[#051329] relative w-full overflow-hidden rounded-lg lg:aspect-[1476/700]">
            <div
            ...
            <div className="relative z-10 flex w-full flex-1 flex-col gap-6 sm:gap-8 lg:h-full lg:min-h-0 lg:flex-row lg:items-stretch lg:justify-between lg:gap-0">
              <div className="flex w-full max-w-[676px] min-w-0 flex-1 flex-col gap-0 px-5 pt-4 pb-8 text-left sm:px-8 lg:h-full lg:min-h-0 lg:pb-10 xl:px-[75px] xl:py-10">
                <div className="flex flex-col gap-3 sm:gap-4 lg:min-h-0 lg:flex-1 lg:justify-center xl:gap-5">
                  <div className="border-border-subtle bg-card-elevated dark:border-[#ffffff40] dark:shadow-[inset_0px_1px_0px_#ffffff40] dark:[background:radial-gradient(50%_50%_at_47%_-32%,rgba(255,255,255,0.32)_0%,rgba(255,255,255,0.08)_100%)] flex w-full max-w-full min-w-0 flex-col items-center justify-center gap-2 rounded-[60.94px] border-[0.5px] border-solid px-2 py-2 text-center sm:flex-row sm:items-center sm:justify-start sm:gap-2 sm:px-0 sm:py-1 sm:pr-3 sm:pl-1 sm:text-left">
                    ...
                    <p className="text-foreground dark:text-white w-full min-w-0 flex-1 text-center [font-family:'Commissioner',Helvetica] text-sm leading-snug font-medium tracking-[0] sm:text-left sm:text-base sm:leading-6">
                      Launch Offer for all New Users | 5% OFF on all purchases
                    </p>
                  </div>

                  <p className="text-foreground dark:text-[#faf7ff] max-w-full text-center [font-family:'Nata_Sans',Helvetica] text-[clamp(1.625rem,4vw+1rem,3.5rem)] leading-[1.05] font-black tracking-[-0.03em] text-balance sm:text-left sm:leading-[1] sm:tracking-[-0.56px]">
                  ...
                  <p className="text-muted-foreground dark:text-white max-w-full text-center [font-family:'Commissioner',Helvetica] text-lg leading-snug font-medium tracking-[0] text-pretty sm:text-left sm:text-xl sm:leading-[26px]">
                  ...
                  <div className="flex w-full max-w-[571px] min-w-0 flex-col items-stretch justify-center gap-4">
                    <div className="border-border-subtle bg-card dark:border-[#ffffff80] dark:[background:linear-gradient(180deg,rgba(255,255,255,0.1)_0%,rgba(255,255,255,0)_100%)] dark:shadow-[0px_0px_0px_4px_#ffffff33] flex w-full min-w-0 flex-wrap items-center justify-between gap-2 rounded-xl border border-solid p-2 backdrop-blur-[12.5px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(12.5px)_brightness(100%)] sm:flex-nowrap sm:gap-0">
                      <div className="inline-flex min-w-0 flex-1 items-center gap-2.5">
                        ...
                        <input
                          ...
                          className="text-foreground/80 placeholder:text-foreground/45 dark:text-white/75 dark:placeholder:text-white/37.5 min-w-0 flex-1 border-none bg-transparent p-0 text-left [font-family:'Commissioner',Helvetica] text-sm leading-6 font-normal tracking-[-0.16px] shadow-none ring-0 ring-offset-0 outline-none focus:border-transparent focus:shadow-none focus:ring-0 focus:outline-none focus-visible:ring-0 focus-visible:outline-none sm:text-base sm:leading-7"
                      ...
                      <button
                        ...
                        className="bg-foreground/10 hover:bg-foreground/15 dark:bg-[linear-gradient(180deg,rgba(255,255,255,0.22)_0%,rgba(255,255,255,0.08)_100%)] dark:hover:bg-[linear-gradient(180deg,rgba(255,255,255,0.3)_0%,rgba(255,255,255,0.12)_100%)] inline-flex size-5 size-[28px] shrink-0 cursor-pointer items-center justify-center self-center rounded-full rounded-md border-0 p-1.5 transition-[opacity,background-color] hover:opacity-100 focus:outline-none active:opacity-90 sm:self-stretch"
                      >
                        <CentralIcon
                    ...
                    <div className="flex w-full justify-center sm:justify-start">
                      <Link
                        href="/shop"
                        className="bg-foreground/10 hover:bg-foreground/15 dark:bg-[#ffffff1a] dark:hover:bg-[#ffffff26] focus-visible:ring-foreground/30 dark:focus-visible:ring-white/30 inline-flex min-h-[44px] w-full max-w-full cursor-pointer items-center justify-center gap-2 rounded-lg border-0 px-4 py-2 text-center transition-colors focus:ring-0 focus:outline-none focus-visible:ring-2 active:bg-[#ffffff1a] sm:min-h-0 sm:w-auto sm:max-w-none sm:justify-center"
                      >
                        <span className="text-foreground dark:text-white -mt-px min-w-0 text-center [font-family:'Commissioner',Helvetica] text-sm font-bold tracking-[-0.16px] sm:text-base sm:leading-7">
                ...
                <div className="flex shrink-0 flex-wrap items-center justify-start gap-x-3 gap-y-2 pt-4 sm:gap-3 lg:pt-8">
                  <div className="text-foreground dark:text-[#faf7ff] min-w-0 [font-family:'Commissioner',Helvetica] text-sm leading-snug font-semibold tracking-[-0.16px] sm:text-base sm:leading-7">
                    Pay securely using
                  </div>
                  <img
          ...
          {categoryTabs.map(({ name, slug, icon }) => (
            <div key={slug || 'all'} className="group relative w-auto">
              ...
              <button
                ...
                className="border-border-subtle bg-card text-foreground/80 hover:border-[#2563eb] hover:bg-[#2563eb] hover:text-white dark:border-gray-600 dark:bg-transparent dark:text-white/70 dark:hover:border-[#005eff] dark:hover:bg-[#005eff] relative z-10 flex min-h-[44px] w-full transform cursor-pointer items-center gap-2 rounded-[99px] border border-dashed px-4 py-3 text-[14px] leading-5 transition-all duration-200 group-hover:-rotate-1 sm:w-auto sm:gap-1 sm:py-2"
              >
                <CentralIcon
