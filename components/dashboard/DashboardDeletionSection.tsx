...
export const DashboardDeletionSection: FunctionComponent = () => {
  ...
  return (
    <section className="font-commissioner p-num-18 box-border flex w-full flex-col gap-4 overflow-hidden rounded-lg border border-dashed border-red-500 text-left text-lg text-white [background:linear-gradient(180deg,rgba(255,42,42,0.2),rgba(255,42,42,0)),linear-gradient(#0d1b35,#0d1b35)] sm:flex-row sm:items-center sm:gap-3">
      ...
      <div className="flex w-full shrink-0 items-stretch text-base sm:w-auto sm:items-center">
        <button
          ...
          className="border-red box-border flex min-h-11 w-full cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-lg border border-solid bg-gray-200 px-3 py-2 sm:min-h-0 sm:w-auto"
        >
          <CentralIcon
            name="IconTrashCan"
            join="round"
