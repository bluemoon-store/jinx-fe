      ...
      <div className="flex flex-col gap-5">
        <header className="flex flex-col gap-3">
          <div className="flex items-center justify-between gap-4">
            <h2 className="leading-num-28 tracking-num-0.02 text-whitesmoke-100 text-[20px] font-extrabold uppercase">
              TXN DETAILS
            </h2>
            <button
              type="button"
              onClick={onClose}
              className="rounded-num-8 h-num-30 w-num-30 flex shrink-0 items-center justify-center border border-solid border-[#18263E] p-0"
              aria-label="Close"
            >
              <CentralIcon
                name="IconCrossSmall"
        ...
        <main className="font-commissioner flex flex-col gap-4">
          <div className="flex items-start justify-between gap-4">
            <b className="leading-num-28 tracking-num-0.02 text-[18px] text-white">{title}</b>
            <b className="leading-num-28 tracking-num-0.02 text-[18px] text-white">{amount}</b>
          </div>
          <div className="h-px w-full bg-gray-100" aria-hidden />
