      ...
      <div className="flex flex-col gap-6 rounded-xl border border-[#eeeeee1a] bg-gray-500 p-4 sm:gap-8 sm:p-6 lg:p-8">
        <div className="flex items-start gap-3 sm:items-center">
          ...
          <div className="min-w-0 flex-1">
            <div className="text-base font-bold tracking-[0.36px] text-white sm:text-lg">Pay with Bitcoin</div>
            <p className="text-sm text-lightsteelblue-200 [text-shadow:0px_0px_8.63px_#00000099] sm:text-base">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex min-h-11 items-center justify-between gap-2 rounded-lg border border-whitesmoke-300 bg-gray-100 px-2 py-2 sm:px-3 sm:py-2.5">
            <Image src={checkoutImg.wallet} alt="" width={18} height={18} className="shrink-0" />
            <span className="min-w-0 flex-1 break-all text-center text-xs font-semibold text-white sm:text-sm md:text-base">
              1FfmbHfnpaZjKFvyi1okTjJJusN455paPH
            </span>
            <Image src={checkoutImg.copyFrame} alt="Copy" width={28} height={28} className="shrink-0" />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex min-h-11 items-center justify-between gap-2 rounded-lg border border-whitesmoke-300 bg-gray-100 px-2 py-2 sm:px-3 sm:py-2.5">
            ...
            <div className="flex min-w-0 flex-1 flex-wrap items-center justify-center gap-2">
              ...
              <span className="text-sm font-semibold text-lightsteelblue-200 sm:text-base">≈</span>
              <span className="text-sm font-semibold text-lightsteelblue-200 sm:text-base">25.03 USD</span>
            </div>
            <Image src={checkoutImg.copyFrame} alt="Copy" width={28} height={28} className="shrink-0" />
          </div>
        </div>
