...
function SuccessCard({
  ...
  return (
    <div className="border-whitesmoke-300 flex flex-col gap-4 rounded-xl border-[1.5px] bg-gray-100 p-4 sm:gap-5 sm:p-6 md:p-[30px]">
      ...
      {sealed ? (
        ...
        >
          <div className="from-fuchsia/40 absolute inset-0 bg-gradient-to-b to-transparent" />
          <Image
...
export function Step5Success() {
  return (
    <div className="flex min-h-[calc(100vh-120px)] flex-col items-center gap-6 px-4 py-8 sm:gap-8 sm:px-6 sm:py-10 lg:px-8">
      ...
      <div className="grid w-full max-w-[1400px] min-w-0 grid-cols-1 gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-[30px]">
        <SuccessCard
          title="Venmo"
          credits="$250 Credits"
          price="$3.00"
      ...
      <Link
        href="/"
        className="text-ghostwhite inline-flex min-h-11 items-center justify-center rounded-lg bg-white/10 px-6 py-2.5 text-sm font-semibold hover:bg-white/15"
      >
        Back to store
      </Link>
    </div>
