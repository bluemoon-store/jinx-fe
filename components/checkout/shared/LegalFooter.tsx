...
export function LegalFooter() {
  return (
    <div className="mt-auto flex w-full min-w-0 flex-wrap items-center justify-center gap-2 pt-6 sm:gap-3 sm:pt-10 md:justify-start">
      ...
      <div className="flex min-w-0 flex-wrap items-center justify-center gap-1 md:justify-start">
        {links.map((label) => (
          <button
            key={label}
            type="button"
