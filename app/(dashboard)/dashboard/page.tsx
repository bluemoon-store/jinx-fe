                  ...
                  return (
                    <button
                      ...
                      className={[
                        ...
                        isSelected
                          ? 'rounded-num-8 border-[#3B3161] text-ghostwhite [background:linear-gradient(90deg,_rgba(235,_45,_255,_0.2),_rgba(235,_45,_255,_0)),_linear-gradient(#071935,_#071935)]'
                  ...
                  return (
                    <button
                      ...
                      className={[
                        ...
                        isSelected
                          ? 'border-[#3B3161] text-ghostwhite [background:linear-gradient(90deg,_rgba(235,_45,_255,_0.2),_rgba(235,_45,_255,_0)),_linear-gradient(#071935,_#071935)]'
                          : 'hover:bg-gray-700',
                        isHoverActive ? 'bg-gray-700' : '',
                      ].join(' ')}
                    >
              ...
              <Reveal variant="slide-right" delay={80}>
                ...
                <div className="text-lightsteelblue-200 flex w-full min-w-0 flex-wrap items-center gap-2 self-stretch rounded-md bg-gray-300 px-3 py-2.5 text-xs sm:w-fit sm:self-auto sm:px-2 sm:py-1.5 sm:text-[12px]">
                  ...
                  <div className="text-ghostwhite flex min-w-0 items-center gap-1.5">
                    <span className="leading-[15px] font-semibold break-all">JNX-LKXJLKNALSDJ</span>
                    <CentralIcon
